...
<html>
	...
	<h:inputText id="id" value="#{customerAuth.custId}" /><br/> 
	<h:message for="form:id"></h:message>
	<br/><br/>	
	<h:outputText value="Customer Otp" />
	<h:inputText id="Otp" value="#{customerAuth.otp}" /><br/>
	<h:message for="form:Otp"></h:message>
	<br/><br/>
	<h:commandButton action="#{ejbImpl.addAuthorization(customerAuth)}" value="Check" />
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
