...
<html>
	...
	<h:inputText id="oldPassWord" value="#{pharmaOldpass.oldPassWord}" /><br/> 
	<h:message for="form:oldPassWord"></h:message>
	<br/><br/>	
	<h:outputText value="PassWord" />
	<h:inputText id="password" value="#{pharmaOldpass.passWord}" /><br/>
	<h:message for="form:password"></h:message>
	<br/><br/>
	
	<h:outputText value="Provider ConfirmPassWord" />
	<h:inputText id="retypePassWord" value="#{pharmaOldpass.resetPasword}" /><br/>
	<h:message for="form:retypePassWord"></h:message>
	<br/><br/>
	
	<h:commandButton action="#{oldpharmacontro.ResetPassWord()}" value="Reset PassWord" />
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
