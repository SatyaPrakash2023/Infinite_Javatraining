...
<html>
	...
	<h:inputText id="phno" value="#{patient.phoneNo}" /><br/>
	...
	<h:inputText id="doctorId" value="#{patient.doctId}" /><br/>
	<h:message for="form:doctorId"></h:message>
	<br/><br/>
	<h:outputText value=" Patient Email" />
	<h:inputText id="email" value="#{patient.email}" /><br/>
	<h:message for="form:email"></h:message>
	<br/><br/>
	<h:commandButton action="#{ejbImpl.addPatientDao(patient)}" value="Add Patient" />
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
